...
export default function Home() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f8faf9", fontFamily: "inherit" }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "center" }}>
          <div>
            ...
            <h1 style={{ fontSize: "42px", fontWeight: 700, color: "white", lineHeight: "1.2", marginBottom: "20px", letterSpacing: "-0.5px" }}>
              Check Your Loan
      ...
      {/* HOW IT WORKS */}
      <div id="how-it-works" style={{ padding: "70px 24px", background: "#f8faf9" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: "16px" }}>
            {steps.map((s, i) => (
              <div key={i} style={{
                ...
                border: "2px solid #d4920a", padding: "24px", textAlign: "center",
              }}>
                <div style={{
                ...
                <h3 style={{ fontSize: "14px", fontWeight: 600, color: "#0a2818", marginBottom: "8px" }}>{s.title}</h3>
      ...
      {/* FEATURES / ABOUT */}
      <div id="about" style={{ padding: "70px 24px", background: "#0a2818", borderTop: "2px solid #d4920a", borderBottom: "2px solid #d4920a" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "16px" }}>
            {features.map((f, i) => (
              <div key={i} style={{
                ...
                <h3 style={{ fontSize: "14px", fontWeight: 600, color: "#f5c842", marginBottom: "8px" }}>{f.title}</h3>
                <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)", lineHeight: "1.6" }}>{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* PARTNER BANKS */}
      <div id="banks" style={{ padding: "70px 24px", background: "#f8faf9" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: "12px", marginBottom: "40px" }}>
            {banks.map((bank, i) => (
              <div key={i} style={{
                ...
                border: "2px solid #d4920a", padding: "16px", textAlign: "center",
              }}>
                <div style={{
                ...
                <p style={{ fontSize: "12px", fontWeight: 500, color: "#0a2818" }}>{bank.name}</p>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: "12px" }}>
            {nbfcs.map((nbfc, i) => (
              <div key={i} style={{
                ...
                <p style={{ fontSize: "12px", fontWeight: 500, color: "#0a2818" }}>{nbfc.name}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{
        ...
        padding: "70px 24px", borderTop: "2px solid #d4920a", textAlign: "center",
      }}>
      ...
      <footer style={{ background: "#050f08", borderTop: "1px solid rgba(245,200,66,0.15)", padding: "40px 24px 20px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ borderTop: "0.5px solid rgba(255,255,255,0.08)", paddingTop: "16px", textAlign: "center" }}>
