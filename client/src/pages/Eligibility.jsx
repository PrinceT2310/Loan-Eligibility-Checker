...
//       <div className="bg-gradient-to-r from-indigo-600 to-blue-500 text-white py-16 text-center">
...
//           Find the best bank offers based on your financial profile
//         </p>
...
//       <div className="max-w-3xl mx-auto -mt-12 bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl p-10 border border-white/40">
...
//               className="border border-gray-200 bg-gray-50 p-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition"
//               onChange={handleChange}
//             />
//           </div>

//           <div>
//             <label className="text-sm text-gray-600">Existing EMI</label>
//             <input
//               name="existingEMI"
...
//           <button
//             className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white py-3 rounded-lg md:col-span-2 hover:scale-[1.02] hover:shadow-lg transition"
//           >
